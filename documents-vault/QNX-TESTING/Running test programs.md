...
4. Click the Edit button (![Icon: Edit button](https://www.qnx.com/developers/docs/7.0.0/com.qnx.doc.ide.userguide/images/icons/edit.png)) on the right of the Launch Configuration dropdown.
5. In the [Main tab](https://www.qnx.com/developers/docs/7.0.0/com.qnx.doc.ide.userguide/topic/launch_configuration_properties.html#qnxlaunchconfigprops__main) of the configuration editor window, enter the path of the test program in the C/C++ Application field.
6. In the [Arguments tab](https://www.qnx.com/developers/docs/7.0.0/com.qnx.doc.ide.userguide/topic/launch_configuration_properties.html#qnxlaunchconfigprops__arguments), check the Test Runner checkbox to enable the test framework selector.
...
9. In the launch bar, click the Run button (![Icon: Run button](https://www.qnx.com/developers/docs/7.0.0/com.qnx.doc.ide.userguide/images/icons/launch.png)).
...
![Screenshot of C/C++ Unit view, with the BasicTest test case entry expanded to show six individual tests, and an error message caused by a test failure displayed at the bottom](https://www.qnx.com/developers/docs/7.0.0/com.qnx.doc.ide.userguide/images/c_cpp_unit.png)  
