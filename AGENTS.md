...
This project is indexed by GitNexus as **CanvasFileHelper** (396 symbols, 936 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/CanvasFileHelper/context` | Codebase overview, check index freshness |
